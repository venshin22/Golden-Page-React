...
export default function About_drpdwn({ isVisible }: {isVisible:boolean}) {
    ...
    return (
        ...
        className="flex absolute top-15 -left-32 z-10 bg-gray-100 divide-y divide-gray-50 rounded-lg shadow-xl w-[30rem] text-gray-600 items-center py-4 px-8 justify-between">
