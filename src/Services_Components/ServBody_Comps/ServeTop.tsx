...
export default function ServeTop () {
    ...
    return(
        <div className="w-full flex flex-col items-center justify-center pt-4 mb-16 gap-4">
            ...
            <div className="flex flex-col md:flex-row w-[65%] lg:w-[75rem] text-white gap-4 justify-between">
                {firstRowCards.map((card, index) => (
                    <ServCard key={index} {...card} />
                ))}
            </div>

            <div className="flex flex-col md:flex-row w-[65%] lg:w-[75rem] text-white gap-4 justify">
